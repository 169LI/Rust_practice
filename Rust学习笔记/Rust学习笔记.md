...
![](image/Pasted_image_20241105203332.png)
...
![](image/Pasted_image_20241105203348.png)
...
cargo run
```
![](image/Pasted_image_20241105203519.png)
成功的构建了一个 Rust 命令行程序！
## 6 调试（debug）
...
为了让长数值更易读，可以在数字之间任意插入下划线。
  ![](image/Pasted_image_20241105203854.png)
